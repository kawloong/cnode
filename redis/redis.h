...
enum _err_
{
    ERR_INNER_SYS = 100, // 内部错误
    ERR_PARAM_INPUT,     // 输入参数有误
    ERR_DATA_TOOBIG,     // 数据量过大
    ERR_INIT_FAIL,       // 初始化失败
    ERR_DONOT_INIT,      // 未初始化
    ERR_DUP_INIT,        // 重复初始化
    ERR_LOADCONF,        // 加载配置文件失败
    ERR_PARSE_TAG,       // 解析<tag>失败
    ERR_INVALID_NAME,    // 无效池名字
